export declare const ALERT_LEVELS: readonly ["normal", "alert", "warn", "alarm", "emergency"];
export declare const DEFAULT_ALERT_LEVELS: readonly ["alert", "warn", "alarm", "emergency"];
export declare const DEFAULT_SLACK_CHANNEL = "#alert";
export declare const DEFAULT_SLACK_TITLE = "Signal K notifications to Slack";
export declare const FALLBACK_DISPLAY_VALUE = "n/a";
export declare const NOTIFICATION_PREFIX = "notifications.";
export declare const NOTIFICATION_SUBSCRIPTION: {
    readonly context: "vessels.self";
    readonly subscribe: readonly [{
        readonly path: "notifications.*";
        readonly policy: "instant";
    }];
};
export declare const SEND_DELAY_MS = 1000;
...
export interface SubscriptionManager {
    subscribe(subscription: SignalKSubscription, unsubscribes: Unsubscribe[], onError: (error: unknown) => void, onDelta: (delta: SignalKDelta) => void): void;
}
export interface SignalKApp {
    ...
    emit(eventName: 'connectionwrite', payload: {
        providerId: string;
    }): void;
}
